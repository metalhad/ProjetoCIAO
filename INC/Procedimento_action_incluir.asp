	  ...
	  <tr> 
		<td>
			<%
				...
				objConn.Open "DBQ=" & Server.MapPath("..\Banco\CIAO_FE.mdb") & ";Driver={Microsoft Access Driver (*.mdb)}","username","password"
				strQuery = "INSERT INTO Procedimento (Desc_Procedimento, Valor_Procedimento, dtCad, UserCad) VALUES ('"&Desc_Procedimento& "','" & Valor_Procedimento & "','" & dtCad & "','" & UserCad &"')"
