...
Response.Expires = 0
	...
	dim Sigla_Servico                : Sigla_Servico                   = TRIM(request.form("Sigla_Servico")) & ""
	  ...
	  <tr> 
		<td>
			<%
				...
				strQuery = "INSERT INTO Servico (Sigla_Servico, Desc_Servico, valor_Servico) VALUES ('" & Sigla_Servico & "','" & Desc_Servico & "','" & valor_Servico &"')"
			...
			<table border="0" width="100%" height="8" cellpadding="2" align="center">
				<tr bgcolor="#0099FF"> 
					<td colspan="7" height="1" align="center"> <font size="2" color="FFFFFF"><b><font face="Verdana, Arial, Helvetica, sans-serif">Seus 
						A descrição "<b><%=Desc_Servico%></b>" foi incluida com sucesso!</font></b></font> 
					</td>
				</tr>
			</table>
			<%else%>
