...
Dim objConn, strQuery, sql_query, RsQuery, campo, sql, cod_procedimento, ObjRs
...
'--------------------------------------------------
cod_procedimento          = trim(Request.Form("cod_procedimento"))

Set objConn =  Server.CreateObject("ADODB.Connection")
objConn.Open "DBQ=" & Server.MapPath(Caminho_Banco) & ";Driver={Microsoft Access Driver (*.mdb)}","username","password"

                       strQuery = "UPDATE Procedimento "
            strQuery = strQuery & "   SET desc_procedimento      = '" & desc_procedimento & "'"
            strQuery = strQuery & " WHERE cod_procedimento       =  " & cod_procedimento
			...
			<table border="0" width="100%" height="8" cellpadding="2" align="center">
				<tr bgcolor="#0099FF"> 
					<td colspan="7" height="1" align="center"> <font size="2" color="FFFFFF"><b><font face="Verdana, Arial, Helvetica, sans-serif"> 
						O procedimento <b>"<%=desc_procedimento%>"</b> foi alterado com sucesso!</font></b></font> 
					</td>
				</tr>
			</table>
			<%else%>
