		...
		<div id="main_container">
			...
			<div id="main_content"> 
				...
				<div class="center_content">
					...
					<br><br><br><br>
					<fieldset>
						<form method="post" action="..\asp\Pacote_action_incluir.asp" name="form" onSubmit="return valida_campo()">
							<div align="center">
								<center>
									<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
										...
										<tr> 
											...
											<td align="left"> 
												<input type="text" name="valor_Pacote" maxlength="255" style="font-family: Verdana; font-size: 8 pt;COLOR: 0000CC;">
											</td>
										</tr>
										
										<tr> 
											<td colspan="4"><font size="2" face="Verdana" color="0000cc">Descrição:</font><br>
												<textarea name="Desc_Pacote" rows="4" cols="60" onKeyUp="ContarTexto(this, 100, 'qtd_caracteres')" style="font-family: Verdana; font-size: 8 pt;COLOR: 0000CC;"></textarea>
												<div id="qtd_caracteres" class="label_left">
													<%=(100 - len(Desc_Pacote))%> caracteres restantes
												</div>
											</td>
										</tr>
										<tr> 
